...
partial record PVplant "The parameters of the overall solar power plant (=a specific installation)"
  ...
  parameter Real panelTilt(
    unit="deg",
    min=0,
    max=90) "Surface tilt in degree (Horizontal equals 0°, vertical equals 90°)";
  parameter Real panelAzimuth(
    unit="deg",
    min=-180,
    max=180) "Surface azimuth in degree (South equals 0°, positive towards east)";
