...
model HorizontalIrradianceToPower
  ...
  SolarPowerSystems.Records.Data.Location_UdS location
    annotation (Placement(transformation(extent={{-90,72},{-70,92}})), choicesAllMatching=true);
  SolarPowerSystems.Records.Data.PVplant_15kWp plantRecord
  ...
  Modelica.Blocks.Tables.CombiTable1Ds inputData(
    ...
    fileName=ModelicaServices.ExternalReferences.loadResource("modelica://SolarPowerSystems/Resources/20181117_t_2m_aswdir_s_aswdifd_s_saarbruecken_60min.txt"),
  ...
  SolarPowerSystems.Components.SolarPowerPlants.Perez_EfficiencyIrradianceArea plantModel(
