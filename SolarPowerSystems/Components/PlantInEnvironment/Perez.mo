...
model Perez
  "Transform horizontal irradiance to normal of arbitrarily oriented surface using the model by Perez"
  ...
  PlaneOfArrayIrradiance.DiffusePerez diffusePerez(til=arrayTilt, rho=albedo) annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={-4,-18})));
  Buildings.BoundaryConditions.SolarIrradiation.BaseClasses.BrighteningCoefficient briCoe annotation (Placement(
        transformation(
        extent={{-6,-6},{6,6}},
        rotation=0,
        origin={-20,20})));
  ...
  Buildings.BoundaryConditions.SolarIrradiation.BaseClasses.SkyClearness skyCle annotation (Placement(
        transformation(
        extent={{6,-6},{-6,6}},
        rotation=0,
        origin={-20,40})));
  ...
  Buildings.BoundaryConditions.SolarIrradiation.BaseClasses.RelativeAirMass relAirMas annotation (Placement(
        transformation(
        extent={{-3,-3},{3,3}},
        rotation=90,
        origin={-61,9})));
equation
  ...
  connect(directHorizontalIrradiance, globalHorizontalIrradiance.u1)
    annotation (Line(points={{60,100},{60,66},{11.6,66},{11.6,63.2}}, color={0,0,127}));
  ...
  connect(briCoe.F1, diffusePerez.briCof1)
    annotation (Line(points={{-13.4,22.4},{-2,22.4},{-2,-6}}, color={0,0,127}));
  connect(briCoe.F2, diffusePerez.briCof2)
    annotation (Line(points={{-13.4,17.6},{-5,17.6},{-5,-6}}, color={0,0,127}));
