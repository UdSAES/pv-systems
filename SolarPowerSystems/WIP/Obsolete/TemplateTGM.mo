...
model TemplateTGM
  ...
  replaceable Records.Data.Location_TGMVienna location constrainedby SolarPowerSystems.Records.Base.Location
    annotation (Placement(transformation(extent={{-90,72},{-70,92}})), __Dymola_choicesAllMatching=true);
  replaceable Records.Data.PVplant_TGM_Trina plantRecord constrainedby SolarPowerSystems.Records.Base.PVplant
