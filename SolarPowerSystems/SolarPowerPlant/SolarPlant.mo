within SolarPowerSystems.SolarPowerPlant;
model SolarPlant
...
equation
  ...
  angle_of_incidence =  get_AngleOfIncidence(zenith,azimuth,panel_slope,panel_azimuth);
