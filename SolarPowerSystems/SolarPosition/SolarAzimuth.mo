within SolarPowerSystems.SolarPosition;
model SolarAzimuth "topocentric azimuth angle (eastward from north)"
...
equation
  ...
  y = SolarPowerSystems.SolarPosition.epoch2azimuth(epoch_time, latitude, longitude, height_above_sealevel);
