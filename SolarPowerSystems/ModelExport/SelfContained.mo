...
model SelfContained "No input/output FMU parameterized from external data files -- BC via tables from file"
...
equation
  ...
  connect(inputData.y[1], plantModel.diffuseHorizontalIrradiance) annotation (Line(points={{-29,0},{-20,0},{-20,3},{-10,3}}, color={0,0,127}));
  connect(inputData.y[2], plantModel.directHorizontalIrradiance) annotation (Line(points={{-29,0},{-20,0},{-20,8},{-10,8}}, color={0,0,127}));
  connect(inputData.y[3], plantModel.temperature) annotation (Line(points={{-29,0},{-20,0},{-20,-8},{-10,-8}}, color={0,0,127}));
